...
public final class PotionSyringeItem extends Item {
    public PotionSyringeItem(Properties properties) {
        super(properties);
    }
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable("item.pxsyringe.potion_syringe.named", potionName);
    }
        ...
        if (level instanceof ServerLevel serverLevel) {
            ...
            contents.forEachEffect(effect -> {
                if (effect.getEffect().value().isInstantenous()) {
                    ...
                    target.addEffect(effect, injector);
                }
            }, durationScale);
